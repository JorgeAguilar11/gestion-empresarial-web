...
> Sistema web para gestión de formularios, tipificaciones y reportes empresariales. Arquitectura de 3 capas con autenticación JWT, API REST y base de datos relacional.

**Uso interno / Desarrollo / Pruebas**
...
Este proyecto es de **uso interno empresarial**. No está diseñado ni probado para ambientes de producción pública.

Código proporcionado "tal cual" sin garantías.
